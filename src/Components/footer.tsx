...
export default function Footer() {
    return (
        <footer className="fixed w-[1366px] h-[147px] bottom-0 left-0 z-50 bg-footerBackground">
            <div className='flex flex-row gap-[19px] w-[97px] h-[20px] ml-[32px] mb-[32px] mt-[95px]'>
